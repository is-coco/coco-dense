...
contextBridge.exposeInMainWorld("vault", {
  ...
  saveAvatar: (data) => ipcRenderer.invoke("avatar:save", data),
  ...
  getAppInfo: () => ipcRenderer.invoke("app:getInfo"),
        getFolderUi: () => ipcRenderer.invoke("folderUi:get"),
  saveFolderUi: (folderUi) => ipcRenderer.invoke("folderUi:save", folderUi),
    findDownloadedUpdate: (assetName) => ipcRenderer.invoke("update:findDownloaded", assetName),
  getUpdateProxy: () => ipcRenderer.invoke("update:getProxy"),
  saveUpdateProxy: (proxyUrl) => ipcRenderer.invoke("update:saveProxy", proxyUrl),
  getUpdateReminder: () => ipcRenderer.invoke("update:getReminder"),
  saveUpdateReminder: (state) => ipcRenderer.invoke("update:saveReminder", state),
  ...
  setDataKeyRemembered: (remember) => ipcRenderer.invoke("vault:setDataKeyRemembered", remember),
  ...
  unlock: (masterPassword, dataKey) => ipcRenderer.invoke("vault:unlock", masterPassword, dataKey),
